...
public enum ModArmorMaterials implements ArmorMaterial {
                ...
                HARDENED_ECCENTRIUM("hardened_eccentrium", 6, new int[]{4, 7, 9, 4}, 34, SoundEvents.BLOCK_AMETHYST_BLOCK_CHIME, 4F, 0.3F, () -> {
                    return Ingredient.ofItems(new ItemConvertible[]{ModItems.HARDENED_ECCENTRIUM_CRYSTAL});
                });
