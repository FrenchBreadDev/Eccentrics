...
import net.frenchbreadev.eccentrics.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.HARDENED_ECCENTRIUM,
                            new StatusEffectInstance(StatusEffects.SPEED, 1200, 1)).build();
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.literal("§9Speed II (1:00)"));
            tooltip.add(Text.literal("§9Haste I (1:00)"));
        } else {
