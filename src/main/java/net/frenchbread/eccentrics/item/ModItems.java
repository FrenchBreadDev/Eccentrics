...
public abstract class ModItems {
    ...
    public static final Item RAW_ECCENTRIUM = registerItem("raw_eccentrium",
            new Item(new FabricItemSettings().rarity(Rarity.UNCOMMON).group(ModItemGroup.ECCENTRICSMISC)));
    ...
    public static final Item ALEXANDRITE_GEM = registerItem("alexandrite_gem",
            new Item(new FabricItemSettings().rarity(Rarity.UNCOMMON).rarity(Rarity.UNCOMMON).group(ModItemGroup.ECCENTRICSMISC)));
    ...
    public static final Item DARK_ECCENTRIUM_CRYSTAL = registerItem("dark_eccentrium_crystal",
            new Item(new FabricItemSettings().rarity(Rarity.EPIC).fireproof().group(ModItemGroup.ECCENTRICSMISC)));
    ...
    public static final Item HARDENED_ECCENTRIUM_HELMET = registerItem("hardened_eccentrium_helmet",
            new ModArmorItem(ModArmorMaterials.HARDENED_ECCENTRIUM, EquipmentSlot.HEAD,
                    new FabricItemSettings().rarity(Rarity.EPIC).group(ModItemGroup.ECCENTRICSCOMBAT)));
   ...
   // public static final Item MUSIC_DISC_SYMPHONY_OF_THE_OVERWORLD = registerItem("music_disc_symphony_of_the_overworld",
    ...
    public static final Item IMPURE_BEDROCK_HELMET = registerItem("impure_bedrock_helmet",
            new ModArmorItem3(ModArmorMaterials2.IMPURE_BEDROCK, EquipmentSlot.HEAD,
                    new FabricItemSettings().rarity(Rarity.RARE).fireproof().group(ModItemGroup.ECCENTRICSCOMBAT)));
    ...
    public static final Item UNKNOWN_FRAGMENT = registerItem("unknown_fragment",
            new Item(new FabricItemSettings().rarity(Rarity.RARE).fireproof().group(ModItemGroup.ECCENTRICSMISC)));
    ...
    public static final Item FRIGID_GAUNTLET = registerItem("frigid_gauntlet",
            new FrigidGauntlet(new FabricItemSettings().rarity(Rarity.EPIC).fireproof().group(ModItemGroup.ECCENTRICSMISC)));

    public static final Item BLAZING_EYE = registerItem("blazing_eye",
            new BlazingEye(new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.ECCENTRICSMISC)));
    ...
    public static final Item ALEXANDRITE_HELMET = registerItem("alexandrite_helmet",
            new ModArmorItem5(ModArmorMaterials3.ALEXANDRITE, EquipmentSlot.HEAD,
                    new FabricItemSettings().rarity(Rarity.RARE).group(ModItemGroup.ECCENTRICSCOMBAT)));
    ...
    /* public static final Item NATURE_STAFF = registerItem("nature_staff",
            new Item(new FabricItemSettings().fireproof().group(ModItemGroup.ECCENTRICSMISC)));
     */
    //public static final Item NETHERITE_MAGMA_GAUNTLET = registerItem("netherite_magma_gauntlet",
          //  new MagmaGauntlet(new FabricItemSettings().rarity(Rarity.EPIC).maxDamage(123).fireproof().group(ModItemGroup.ECCENTRICSMISC)));

    public static final Item HEALING_SHARD = registerItem("healing_shard",
          new HealingShard(new FabricItemSettings().fireproof().group(ModItemGroup.ECCENTRICSMISC).food(ModFoodComponents.HEALING_SHARD)));
