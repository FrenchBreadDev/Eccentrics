...
public class EffectKarambit extends SwordItem {
    public EffectKarambit(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if(Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.literal("§cSlowness I §7(0:05)"));
        } else {
