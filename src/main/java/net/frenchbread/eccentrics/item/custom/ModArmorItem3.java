...
import net.frenchbread.eccentrics.item.ModArmorMaterials2;
...
public class ModArmorItem3 extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials2.IMPURE_BEDROCK,
                        new StatusEffectInstance(StatusEffects.RESISTANCE, 1200, 1)).build();
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.literal("§9Resistance II"));
            tooltip.add(Text.literal("§9Slowness I"));
        } else {
